...
SetupFileCorruptOrWrongVer=Installationsfilerna är felaktiga, eller stämmer ej överens med denna version av installationsprogrammet. Rätta felet eller hämta en ny programkopia.
NotOnThisPlatform=Detta program kan ej köras på %1.
OnlyOnThisPlatform=Detta program kräver %1.
...
SetupAppRunningError=Installationsprogrammet har upptäckt att %1 körs för tillfället.%n%nStäng all öppna instanser av det nu, klicka sedan på OK för att gå vidare, eller Avbryt för att avsluta.
UninstallAppRunningError=Avinstallera har upptäckt att %1 körs för tillfället.%n%nStäng all öppna instanser av det nu, klicka sedan på OK för att gå vidare, eller Avbryt för att avsluta.
...
ExitSetupMessage=Installationen är inte färdig. Om du slutar nu, kommer programmet inte att installeras.%n%nDu kan starta installationsprogrammet igen senare om du vill slutföra den då istället.%n%nVill du avbryta installationen?
AboutSetupMenuItem=Om installationen...
AboutSetupTitle=Om installationen
AboutSetupMessage=%1 version %2%n%3%n%n%1 hemsida:%n%4
AboutSetupNote=Svensk översättning är gjord av dickg@go.to 1999, 2002%n%nUppdatering till 3.0.2+ av peter@peterandlinda.com, Kerstin & Ragnar
...
; *** Common wizard text
ClickNext=Klicka på Nästa för att fortsätta, eller Avbryt om du vill avbryta installationen.
BeveledLabel=
...
LicenseLabel=Var god läs följande viktiga information innan du fortsätter.
LicenseLabel3=Var god läs följande licensavtal. Du måste acceptera villkoren i avtalet innan du kan fortsätta med installationen.
...
UserInfoDesc=Var god fyll i följande uppgifter:
UserInfoName=Namn:
...
SelectDirLabel=Välj den mapp där du vill att [name] ska installeras, tryck sedan på Nästa.
...
DiskSpaceWarning=Installationsprogrammet behöver åtminstone %1 KB av fritt utrymme för installationen, men den valda enheten har bara %2 KB tillgängligt.%n%nVill du fortsätta ändå?
...
SelectComponentsLabel2=Välj de komponenter du vill ska installeras; avmarkera de komponenter du inte vill ha. Tryck på Nästa när du är klar att fortsätta.
...
SelectTasksLabel2=Välj extra uppgifter för installationsprogrammet att utföra vid installation av [name], tryck sedan på Nästa.
...
SelectStartMenuFolderLabel=Välj den Startmeny-mapp där du vill skapa programmets genvägar, tryck sedan på Nästa.
NoIconsCheck=Skapa inte ikoner
MustEnterGroupName=Du måste ange en mapp.
BadGroupName=Mappnamnet kan inte innehålla något av följande tecken:%n%n%1
...
;WizardFinished=Installationen är nu klar
FinishedHeadingLabel=Avslutar installationen av [name]
FinishedLabelNoIcons=[name] har nu installerats på din dator.
FinishedLabel=[name] har nu installerats på din dator. Starta programmet genom att välja någon av ikonerna.
ClickFinish=Välj Slutför för att avsluta installationen.
FinishedRestartLabel=För att slutföra installationen av [name], måste din dator startas om. Vill du starta om nu?
FinishedRestartMessage=För att slutföra installationen av [name], måste din dator startas om.%n%nVill du starta om datorn nu?
...
SetupAborted=Installationen slutfördes inte.%n%nVar god rätta till felet och kör Installationsprogrammet igen.
EntryAbortRetryIgnore=Välj Försök igen eller Ignorera för att fortsätta ändå, Avbryt för att avbryta installationen.
...
; *** File copying errors
FileAbortRetryIgnore=Välj Försök igen eller Ignorera för att hoppa över denna fil (ej rekommenderat), eller Avbryt installationen.
...
FileExists=Filen finns redan.%n%nSka installationsprogrammet skriva över den?
ExistingFileNewer=Den befintliga filen är nyare än den du försöker installera. Du rekommenderas behålla den befintliga filen. %n%nVill Du behålla den befintliga filen?
...
ErrorRenamingTemp=Ett fel uppstod vid försök att byta namn på en fil i installationsmappen:
...
UninstallUnsupportedVer=Avinstallationsloggen "%1" har ett innehåll som denna version av installationsprogrammet inte känner igen. Kan ej avinstallera
...
UninstallStatusLabel=Var god vänta medan %1 tas bort från din dator.
UninstalledAll=%1 är nu borttagen från din dator.
...
ConfirmDeleteSharedFile2=Detta system indikerar att följande delade filer inte längre används av några program. Vill du ta bort den delade filen?%n%n%1%n%nOm något program fortfarande använder denna fil och den raderas, kanske programmet inte fungerar ordentligt. Är du osäker, välj Nej. Det kommer inte att skada systemet.
